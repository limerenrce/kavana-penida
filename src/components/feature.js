...
export default function Feature() {
  return (
    <>
      <div className="mt-16 flex flex-col md:flex-row items-start justify-center gap-8 px-4 md:px-20">
        {/* Feature Card */}
        <div className="flex flex-col items-center text-center max-w-sm w-full p-6">
          {/* SVG Icon */}
        ...
        {/* Duplicate and adjust for other cards... */}
      </div>
